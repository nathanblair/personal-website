...
<p class="bg-slate-400 dark:bg-slate-800">
	...
	OH but I attended the University of Cincinnati during my first three years of
...
<p class="">
	...
	extremely diverse individual and have a wide array of interests. It stems from
	the fact that I have an addiction to solving challenging problems and a
...
<p class="bg-slate-400 dark:bg-slate-800">
	...
	and occasionally the piano. My personal aspirations are to be a good person
	each day, leaving the world a little better than the day before. To accomplish
	this on a larger scale I am committed to advocating renewable and sustainable
